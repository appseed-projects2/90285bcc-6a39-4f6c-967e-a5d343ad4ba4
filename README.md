...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-17 09:00`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/90285bcc-6a39-4f6c-967e-a5d343ad4ba4.git
$ cd 90285bcc-6a39-4f6c-967e-a5d343ad4ba4
```
